function CB_Mojo_Extension() {
            ...
            success: function(response) {
                ...
                if (response.ticket) {
                    ...
                    if (cb_mojo_ext.mojo_domain != "") {
                        var ticket_link = "<a id='open_ticket' " + extended_style + " href='https://" + cb_mojo_ext.mojo_domain + "/tech/#" + ticket_id + "' target='_blank'>Open The Ticket</a><br/>"
                    }
    ...
    cb_mojo_ext.create_form = function() {
        var html = "<div id='" + cb_mojo_ext.popup_id + "' class=\"draggable\">";
