//Originally derived from https://www.sitepoint.com/community/t/add-days-to-date-while-ignoring-weekends-and-holidays-possible/3827/3
var Bday = {
    ...
    getHolidays: function(year) {
        ...
        if (Bday.holidays['y_' + year])
            return Bday.holidays['y_' + year];
