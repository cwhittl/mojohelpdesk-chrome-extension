...
Shared.create_custom_fields = function(ticket, cb_mojo_ext, state, changeHandler) {
  //var custom_field_types = ticket.custom_field_types;
  //var custom_field_values = ticket.custom_field_values;
  var custom_field_attributes = ticket.related_data.field_attributes;
...
Shared.create_user_info = function(user) {
  ...
  return R.div({
    ...
    className: "time_info"
  }, "On " + Shared.getLocalTimeFromGMT(user.updated_on)));
};
Shared.create_input = function(name, type, value, changeHandler, placeholder) {
  var props = {
    id: name,
