function CB_Mojo_Extension(afterLoadFunction) {
    ...
    cb_mojo_ext.automated_avatar_url = chrome.extension.getURL("images/icons/optimus.gif");
    cb_mojo_ext.default_user_avatar_url = chrome.extension.getURL("images/icons/default_user.png");
