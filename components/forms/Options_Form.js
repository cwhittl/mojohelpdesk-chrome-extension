var Options_Form = React.createClass({
  ...
  render_content: function(event) {
    ...
    var slas_fieldset = Shared.createFieldSet({
      ...
      id: "slas",
      labelChild: Shared.createMoreInfo({
        help_image: "../../options/images/slas.png",
        help_text: "Define the service level agreements for each priority.",
        onHelp: this.onHelp
      })
    }, sla_table);
    var enforce_slas_fieldset = Shared.createFieldSet({
      ...
      id: "enforce_slas",
      labelChild: Shared.createMoreInfo({
        help_image: "../../options/images/detailed_slas.jpg",
        help_text: "Do you want to enforce the SLAs noted above (This will lock down the dates and only change with priority)?",
        onHelp: this.onHelp
      })
    }, R.input({
      className: "form-control",
