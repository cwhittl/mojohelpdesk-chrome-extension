var Ticket_Update_Form = React.createClass({
    ...
    getInitialState: function() {
        return {ticket_id: null, potential_assignees: null};
    },
    ...
    assignToMe: function(event) {
        ...
        this.setState({assigned_to_id: this.props.cb_mojo_ext.mojo_agent_id});
    },
    ...
    render_content: function(event) {
        ...
        controls.push(Shared.create_custom_fields(this.props.ticket, this.props.cb_mojo_ext, this.state, this.handleChange));
        return R.div({}, form({
            ...
            key: "status"
        }, this.state.status_message), controls), input({type: "submit", className: "update_ticket", value: "Update Ticket", onClick: this.updateForm}));
    },
    render: function() {
